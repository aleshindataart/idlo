...
/* themes/contrib/flexi_style/templates/menu/menu.html.twig */
class __TwigTemplate_80c34aa939f41d6b73f5989143ec1064 extends Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 40
                    echo "      <ul ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["menu", ($context["primary_nav_level"] ?? null)], "method", false, false, true, 40), 40, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 42
                    echo "      <ul ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["submenu", ($context["primary_nav_level"] ?? null)], "method", false, false, true, 42), 42, $this->source), "html", null, true);
                    echo ">
    ";
                }
                // line 44
...
$context["item"], "below", [], "any", false, false, true, 66)) ? ("menu-link-has-children") : (""))];
  ...
  ";
    ...
    {
        return "themes/contrib/flexi_style/templates/menu/menu.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/flexi_style/templates/menu/menu.html.twig", "/var/www/html/web/themes/contrib/flexi_style/templates/menu/menu.html.twig");
    }
